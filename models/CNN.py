...
class CNN(nn.Module):
    ...
    def __init__(
        ...
        # ============================================================
        # BRANCHE CNN: Traitement des spectres
        # ============================================================
        self.conv_layers = nn.ModuleList()
        in_channels = 1  # Spectre = 1 canal
        ...
        # ============================================================
        # BRANCHE MLP: Traitement des données auxiliaires
        # ============================================================
        ...
        # ============================================================
        # Dimension fusionnée = dernière conv channel + 64 (MLP auxiliaire)
    ...
    def forward(self, spectrum: torch.Tensor, auxiliary: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            spectrum: (batch_size, 1, spectrum_length)
        ...
        """
        # ============================================================
        # Branche CNN: Traitement du spectre
        # ============================================================
        x_spectrum = spectrum
